...
The sources for Sklearn xarray can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/nbren12/sklearn_xarray
.. _tarball: https://github.com/nbren12/sklearn_xarray/tarball/master
